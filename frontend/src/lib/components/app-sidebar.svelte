<script lang="ts">
  ...
  import { Bug, Link2, ChartNoAxesCombined, ChartNoAxesGantt, Gauge, ListEnd } from "@lucide/svelte";
  ...
  const sidebarItems = [
    ...
    {Icon: ListEnd, href: "/tasks", title: "Tasks", stickyParams: ['presets', 'from', 'to']}, // ChartNoAxesGantt
